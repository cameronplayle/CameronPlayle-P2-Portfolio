...
I specialize in data-driven decision-making, predictive modeling, and statistical analysis, with a passion for baseball analytics. My experience includes working with the UTSA baseball team where I contribute to performance data analysis and develope predictive models to enhance player development. My current research focuses on predicting injury risks, such as Tommy John surgery, using logistic regression and machine learning models, while also evaluating performance metrics that help teams optimize their strategies.
